...
![Comando1](assets/images/1comandoSudoAptUpdate.png)
...
![Comando2](assets/images/2comandoStatusNginx.png)
...
![Comando3](assets/images/3comandoCreacionCarpetaWeb.png)
...
![Comando9](assets/images/9comandoObtencionIpMAquina.png)

Solo queda introducirlo en el navegador y si todo va bien tendremos el siguiente resultado.

![Comando8](assets/images/8comandoComprobacionServidor.png)
...
![Comando11](assets/images/11comandoEntrarSitestAvaliable.png)

Y lo modificaremos de la siguiente forma: 

![Comando10](assets/images/10comandoConfSitesAvaliable.png)

Ruta del index ; 

![Comando12](assets/images/12comandoCarpetaGitDesc.png)
...
![Comando13](assets/images/13comandoArchivoSitesEnable.png)

Reiniciaremos el servidor para aplicar todos los cambios hechos: 

![Comando14](assets/images/14comandoRestartNginx.png)
...
![Comando15](assets/images/15comandoAsignarIpaDominio.png)
...
![Comando16](assets/images/16comandoComprobacionPeticiones.png)
...
![Comando17](assets/images/17comandoUpdate.png)

![Comando18](assets/images/18comandoInstallVsftpd.png)

Crearemos una carpeta en nuestro home en debian. 

![Comando19](assets/images/19comandoCreacionCarpta.png)
...
![Comando20](assets/images/20comandoCertificadosSeguridad.png)

Una vez terminado, cambiamos la configuración de vsftpd con el editor de textos. 

![Comando21](assets/images/21comandoConfVsftpd.png)
...
![Comando22](assets/images/22comandoModificacionArchivoConf.png)

Tras guardar la configuración, reiniciaremos el servicio. 

![Comando23](assets/images/23ComandoReiniciar.png)
...
![Comando24](assets/images/24comandoParametroFilezilla.png)

Aceptamos el certificado desconocido, ya que al ser nuestro servidor no hay peligro. 

![Comando25](assets/images/25comandoAceptaCertificadoDesconocido.png)

Tras esto comprobaremos que la conexión se ha realizado con éxito. 

![Comando26](assets/images/26comandoConexionServidor.png)

Probaremos a subir un archivo desde nuestra máquina local a la virtual. Comprobando que ha sido satisfactoria. 

![Comando27](assets/images/27comandoConfirmaciónSubida.png)

![Comando28](assets/images/28comandoTransaccionSatisfactoria.png)
...
![Comando29](assets/images/29comandoUpdateInstallSSL.png)
...
![Comando30](assets/images/30comandoCreaciónYConfi.png)
...
![Comando31](assets/images/31comandoEdiciónArchivoConf.png)
...
![Comando32](assets/images/32comandoComprobaciónConf.png)


## Resultado 
Si todo ha salido bien, al buscar tu dominio en el navegador debe darte esta salida: 

![Comando33](assets/images/33comandoVisitaHTTPS.png)
