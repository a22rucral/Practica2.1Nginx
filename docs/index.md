...
![Comando1](/docs/assets/images/1comandoSudoAptUpdate.png)
...
![Comando2](/docs/assets/images/2comandoStatusNginx.png)
...
![Comando3](/docs/assets/images/3comandoCreacionCarpetaWeb.png)
...
![Comando9](/docs/assets/images/9comandoObtencionIpMAquina.png)

Solo queda introducirlo en el navegador y si todo va bien tendremos el siguiente resultado.

![Comando8](/docs/assets/images/8comandoComprobacionServidor.png)
...
![Comando11](/docs/assets/images/11comandoEntrarSitestAvaliable.png)

Y lo modificaremos de la siguiente forma: 

![Comando10](/docs/assets/images/10comandoConfSitesAvaliable.png)

Ruta del index ; 

![Comando12](/docs/assets/images/12comandoCarpetaGitDesc.png)
...
![Comando13](/docs/assets/images/13comandoArchivoSitesEnable.png)

Reiniciaremos el servidor para aplicar todos los cambios hechos: 

![Comando14](/docs/assets/images/14comandoRestartNginx.png)
...
![Comando15](/docs/assets/images/15comandoAsignarIpaDominio.png)
...
![Comando16](/docs/assets/images/16comandoComprobacionPeticiones.png)
...
![Comando17](/docs/assets/images/17comandoUpdate.png)

![Comando18](/docs/assets/images/18comandoInstallVsftpd.png)

Crearemos una carpeta en nuestro home en debian. 

![Comando19](/docs/assets/images/19comandoCreacionCarpta.png)
...
![Comando20](/docs/assets/images/20comandoCertificadosSeguridad.png)

Una vez terminado, cambiamos la configuración de vsftpd con el editor de textos. 

![Comando21](/docs/assets/images/21comandoConfVsftpd.png)
...
![Comando22](/docs/assets/images/22comandoModificacionArchivoConf.png)

Tras guardar la configuración, reiniciaremos el servicio. 

![Comando23](/docs/assets/images/23ComandoReiniciar.png)
...
![Comando24](/docs/assets/images/24comandoParametroFilezilla.png)

Aceptamos el certificado desconocido, ya que al ser nuestro servidor no hay peligro. 

![Comando25](/docs/assets/images/25comandoAceptaCertificadoDesconocido.png)

Tras esto comprobaremos que la conexión se ha realizado con éxito. 

![Comando26](/docs/assets/images/26comandoConexionServidor.png)

Probaremos a subir un archivo desde nuestra máquina local a la virtual. Comprobando que ha sido satisfactoria. 

![Comando27](/docs/assets/images/27comandoConfirmaciónSubida.png)

![Comando28](/docs/assets/images/28comandoTransaccionSatisfactoria.png)
...
![Comando29](/docs/assets/images/29comandoUpdateInstallSSL.png)
...
![Comando30](/docs/assets/images/30comandoCreaciónYConfi.png)
...
![Comando31](/docs/assets/images/31comandoEdiciónArchivoConf.png)
...
![Comando32](/docs/assets/images/32comandoComprobaciónConf.png)


## Resultado 
Si todo ha salido bien, al buscar tu dominio en el navegador debe darte esta salida: 

![Comando33](/docs/assets/images/33comandoVisitaHTTPS.png)
